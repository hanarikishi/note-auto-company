...
| フェーズ | 条件 | 変更内容 |
|---|---|---|
| 現状（Phase 1） | 立ち上げ〜1ヶ月 | 週1本・Buffer無料10本/月。システムの品質を育てる期間 |
| Phase 2 | 1ヶ月後（システム安定後） | 週2本に増産。月曜・木曜の2回バッチ実行。わし作業は週50〜60分 |
| Phase 3 | 月5万円売上達成 | X API Basic（$100/月）で自動予約投稿。わしの作業が週15分に削減 |
| Phase 4 | 月10万円売上達成 | 並列エージェント化。週4〜5本体制へ |
